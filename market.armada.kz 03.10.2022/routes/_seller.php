...
Route::group(['middleware' => ['auth','isSeller'],'prefix' => 'seller', 'as' => 'seller.', 'namespace' => 'Seller',], function () {
    ...
    //export to xml
    Route::get('/exportdata/{file_type}','ProductControllerSeller@exportdata')
        ->name('export_data');
    //export to excel
    ...
    Route::post('/create-products-with-image',[ProductControllerSeller::class, 'createWithImages'])->name('createWithImages');
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::resource('/products','ProductControllerSeller')->only([
                'index', 'create', 'store'
            ]);
        Route::group(['middleware' => ['isProductInDiscountZone']], function () {
            Route::resource('/products', 'ProductControllerSeller')
                ->parameters(['products' => 'id'])->only([
