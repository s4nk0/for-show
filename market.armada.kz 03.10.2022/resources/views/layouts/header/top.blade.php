<div class="header__top">
    ...
    @include('banners.wide_top_banner')
    <div class="container">
        <div class="header__top-wrap">
            <nav class="header__top-pages">
                <ul>
                    ...
                    <li>{{__('messages.main.header.city.almaty')}}</li>
                </ul>
            </nav>
            <div class="header__info">
{{--                <a href="{{url()}}"></a>--}}
                <a href="{{route('setlocale', ['lang' => 'kk'])}}">Қаз</a>
                <a href="{{route('setlocale', ['lang' => 'ru'])}}">Рус</a>
                <a href="{{ route('scheme') }}" class="d-flex align-items-center">
                    ...
                    <span>{{__('messages.main.links.scheme')}}</span>
                </a>
                <span class="d-flex align-items-center">
                    ...
                    <span>{{__('messages.main.header.working_hours')}}</span>
                </span>
