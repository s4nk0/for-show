...
{{--<!--                            <li><a href="{{ route('furnitureCare') }}">Уход за мебелью</a></li>-->--}}
                ...
                <div class="footer__categories col-12 col-md-3">
                    ...
                    <nav class="footer__nav">
                        <ul>
                            <li><a href="{{ asset('files/Privacy-Policy.docx') }}" download="Политика конфиденциальности">{{__('messages.main.footer.links.policy')}}</a></li>
                            <li><a href="{{ asset('files/Terms-of-use.docx') }}" download="Согласие на обработку персональных данных">{{__('messages.main.footer.links.terms')}}</a></li>
                            <li><a href="{{ asset('files/Personal-data.docx') }}" download="Пользовательское соглашение">{{__('messages.main.footer.links.personal')}}</a></li>
                        </ul>
                    </nav>
                </div>
