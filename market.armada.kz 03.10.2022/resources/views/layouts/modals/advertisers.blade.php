        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header px-4">
                    <h5 class="modal-title">{{__('messages.application.for_ads')}}</h5>
                ...
                <div class="modal-body request modal__request px-4 pb-4">
                    ...
                    <form action="{{ route('applicationPost') }}" id="applicationPost111111" method="POST">
                        ...
                        <div class="form-group">
                            <label for="organization">{{__('messages.application.organization')}} <span style="color: #E0001A">*</span> </label>
                            <input type="text" class="form-control" name="organization" id="organization" placeholder="{{__('messages.application.organization')}}..." required>
                        </div>
                        <div class="form-row">
                            <label class="col-12">{{__('messages.application.name')}} <span style="color: #E0001A">*</span></label>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" name="name" id="name" placeholder="{{__('messages.application.name.contact')}}..." required>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" name="position" id="position" placeholder="{{__('messages.application.name.position')}}..." required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 col-form-label">{{__('messages.application.ad_type')}}</div>
                            <div class="col-sm-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="ad_type1" id="ad-type1" >
                                    <label class="custom-control-label" for="ad-type1">{{__('messages.application.ad_type1')}}</label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="ad_type2" id="ad-type2" >
                                    <label class="custom-control-label" for="ad-type2">{{__('messages.application.ad_type2')}}</label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="ad_type3" id="ad-type3" >
                                    <label class="custom-control-label" for="ad-type3">{{__('messages.application.ad_type3')}}</label>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
