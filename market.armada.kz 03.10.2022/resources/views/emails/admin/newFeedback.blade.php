                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="padding: 1rem 2rem;">
                                        <h2 style="margin: 0">Новый отзыв о сайте</h2>
                                        <div style="padding: 1rem 2rem;">
                                            <p class="client-name">
                                                <span>Имя: </span><span>{{$feedback['name']}}</span>
                                            </p>
                                            <p class="client-email">
                                                <span>Эл. адрес</span> : <span>{{$feedback['email']}}</span>
                                            </p>
                                            <p class="client-phone">
                                                <span>Комментарий</span> : <span>{{$feedback['comment']}}</span>
                                            </p>
