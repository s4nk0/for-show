            ...
            <div class="vendor__content vendor__content--settings flex-grow-1 bg-light vendor__content--panel">
                ...
                <div class="panel orders vendor__panel mt-lg-2 pt-4 pb-3 p-lg-3 pr-0">
                    <div class="user-block">
                        <form action="{{ route('designer.infoEdit') }}" class="user-block__wrap" id="seller-edit" method="POST">
                            @csrf
                            ...
                            <div>
                                @include('designer.personal_data._personal')
                                @include('designer.personal_data._contact')
                                @include('designer.personal_data._auth')
{{--                                @include('designer.personal_data._avatar')--}}
