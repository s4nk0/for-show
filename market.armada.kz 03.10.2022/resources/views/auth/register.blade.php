...
@section('content')
    ...
    <div class="page-login__bg" style="background: url('{{ asset('img/sections-bg/register-bg.jpg') }}')">
        ...
        <form {{ route('register') }} class="d-flex flex-column justify-content-between h-100 needs-validation" novalidate method="POST">
            ...
            <div>
                <h3 class="h4 pb-3 border-bottom text-center login__title">{{__('messages.auth.sign_up')}}</h3>
...
{{--                    <x-form.verify-phone-inputs label="{{__('messages.auth.register.tel')}}" type="tel" name="phone" id="register-phone" class="form-control mb-0" value="{{ old('phone') }}" autocomplete="phone" placeholder="+7 (---) --- -- --" required />--}}
...
{{--                    <label for="register-phone">{{__('messages.auth.register.tel')}}</label>--}}
                ...
                <p class="text-center">
                    <a href="{{ route('login') }}" class="d-flex align-items-center justify-content-center font-weight-semibold login__as-seller">
                        <span class="mr-2">{{__('messages.auth.user.already_register')}}</span>
...
{{--                    </p>--}}
            ...
            <div class="text-center mt-2">
                <div class="d-flex align-items-center justify-content-between" style="color: #787878;">
                    ...
                    <span class="col" style="white-space: nowrap">{{__('messages.auth.log_as_user')}}</span>
                    <span class="flex-grow-1"><hr></span>
                </div>
