    ...
    <div class="page-login__bg page-login__bg--seller" style="background: url('{{ asset('img/sections-bg/vendor-login-bg.jpg') }}')">
        <div class="login login--register page-login__login">
            <form action="{{ route('register') }}" class="d-flex flex-column justify-content-between h-100 needs-validation" novalidate method="POST">
                ...
                <div>
                    <h3 class="h4 pb-3 border-bottom text-center login__title">{{__('messages.auth.designer.register')}}</h3>
                    ...
                    <div class="row">
                        <div class="col-12 col-xl">
                            <div class="md-form mt-0 mb-xl-0 md-outline input-with-pre-icon">
                                ...
                                <label for="register-name">{{__('messages.your_name')}}</label>
                                <div class="invalid-feedback">
                                    {{__('messages.auth.register.please_enter_name')}}
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-xl">
                            <div class="md-form m-0 md-outline input-with-pre-icon">
                                ...
                                <label for="register-surname">{{__('messages.your_sur_name')}}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md-form mb-0 md-outline input-with-pre-icon">
                        ...
                        <label for="register-phone">{{__('messages.auth.register.tel')}}</label>
                        <div class="invalid-feedback">
                            {{__('messages.auth.register.please_enter_tel')}}
                        </div>
                    </div>
                    <div class="md-form mb-0 md-outline input-with-pre-icon">
                        ...
                        <div class="invalid-feedback">
                            {{__('messages.auth.register.please_enter_email')}}
                        </div>
                    </div>
                    <div class="md-form md-outline input-with-pre-icon show_hide_password">
                        ...
                        <label for="register-password">{{__('messages.auth.register.password')}}</label>
                        <div class="password-view">
                            <a href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                        </div>
                        <div class="invalid-feedback">
                            {{__('messages.auth.register.please_enter_password')}}
                        </div>
                    </div>
                    <div class="md-form md-outline input-with-pre-icon show_hide_password">
                        <svg class="input-prefix" width="13" height="17" viewBox="0 0 13 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label for="register-password-repeat">{{__('messages.auth.register.re_password')}}</label>
                        <div class="password-view">
                            <a href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                        </div>
                        <div class="invalid-feedback">
                            {{__('messages.auth.register.password_not_match')}}
                        </div>
                    </div>
                    <button class="button btn-primary btn-block my-4 text-uppercase rounded" type="submit">{{__('messages.auth.register')}}</button>
                    <p class="text-center">
                        <a href="{{ route('sellerLogin') }}" class="d-flex align-items-center justify-content-center font-weight-semibold login__as-seller">
                            <span class="mr-2">{{__('messages.auth.seller.already_register')}}</span>
                ...
                <div class="text-center mt-2">
                    <div class="d-flex align-items-center justify-content-between" style="color: #787878;">
                        ...
                        <span class="col" style="white-space: nowrap">{{__('messages.auth.log_or_register_as_buyer')}}</span>
                        <span class="flex-grow-1"><hr></span>
                    </div>
                    <div class="text-center">
                        <a href="{{ route('login') }}" class="font-weight-semibold text-underline ml-3">{{__('messages.auth')}}</a>
                    </div>
                    <div class="text-center">
                        <a href="{{ route('register') }}" class="font-weight-semibold text-underline ml-3">{{__('messages.auth.sign_up')}}</a>
                    </div>
                </div>
            </form>
        </div>
