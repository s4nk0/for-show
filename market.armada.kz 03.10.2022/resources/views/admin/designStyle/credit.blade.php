        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form action="@isset($data){{ route('admin.designer-styles.update',$data->id) }}@else{{ route('admin.designer-styles.store') }}@endisset" class="change-shop pb-4 border-bottom was-validated" method="POST"  enctype="multipart/form-data">
                        @isset($data) @method('PATCH') @endisset
                        @csrf

                        <div class="row">
                            <div class="col-4 col-lg mb-3">
                                @include('layouts.forms.input',['name'=>'color','type'=>'color','label'=>'Цвет','placeholder'=>'Цвет','length'=>150,'required'=>true])
                            </div>
                            <div class="col-4 col-lg mb-3">
                                @include('layouts.forms.input',['name'=>'title','label'=>'Title','placeholder'=>'Title','length'=>15,'required'=>true])
                            </div>
{{--                            <div class="col-4 col-lg mb-3">--}}
{{--                                @include('layouts.forms.input',['name'=>'title','label'=>'Название RU','placeholder'=>'Название RU','length'=>50,'required'=>true])--}}
{{--                            </div>--}}
