        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form
                        action="@isset($data){{ route('admin.products.update',$data->id) }}@else{{ route('admin.products.store') }}@endisset"
                        class="change-shop pb-4 border-bottom was-validated" method="POST"
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text" style="height: 38px;">
                                            <input class="form-check-input" type="checkbox" name="is_slug" id="is_slug"
                                                   @if(isset($data) and $data->is_slug == true) checked @endif>
                                ...
                                <div class="price_input_wrapper">
                                    <div class="flex-1">
                                        @include('layouts.forms.input',
                                            ...
                                            'type'=>'number',
                                            'step'=>'0.01',
                                            'label'=> (isset($data) and $data->is_price_from == true) ? 'Цена от' : 'Цена',
                                            'placeholder'=>(isset($data) and $data->is_price_from == true) ? 'Цена от' : 'Цена',
                                            'pattern'=>'[0-9]{0,15}',
                                            'max'=>999999999999999,
                                            'length'=>15,
                                            'other'=>(isset($data) and $data->is_price_none == true) ? 'readonly' : ''
                                            ])
                                    </div>
                                </div>
{{-- Ask to remove prrice from, and as seller --}}
{{--                                <div class="price_type_wrapper">--}}
{{--                                    <div>--}}
{{--                                        <input class="form-check-input"--}}
{{--                                               type="checkbox"--}}
{{--                                               name="is_price_from"--}}
{{--                                               id="is_price_from"--}}
{{--                                                @if(isset($data) and $data->is_price_from == true)--}}
{{--                                                    checked--}}
{{--                                                @endif--}}
{{--                                        />--}}
{{--                                        <label class="form-check-label" for="is_price_from">--}}
{{--                                            Цена от--}}
{{--                                        </label>--}}
{{--                                    </div>--}}
{{--                                    <div>--}}
...
{{--                                               name="is_price_none"--}}
{{--                                               id="is_price_none"--}}
{{--                                                @if(isset($data) and $data->is_price_none == true)--}}
{{--                                                    checked--}}
{{--                                                @endif--}}
{{--                                        />--}}
{{--                                        <label class="form-check-label" for="is_price_none">--}}
{{--                                            Уточнить цену у продавца--}}
{{--                                        </label>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            ...
                            <div class="col-12 col-lg mb-3">
                                <div>
                                    <label class="d-flex align-items-end justify-content-between">
                                        ...
                                        <span class="material-tooltip-main d-inline-block" data-toggle="tooltip"
                                              data-tippy-content="Поле должно содержать краткое описание товара для помощи в поисковой системе.<br><b>Например: комфортная массивная мебель дивана. Обивка дивана из элитных тканей, основание сделано из натуральеого дерева, имеются кожаные вставки</b>">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11 22C8.0618 22 5.29947 20.8558 3.2218 18.7782C1.14421 16.7005 0 13.9382 0 11C0 8.0618 1.14421 5.29947 3.2218 3.2218C5.29947 1.14421 8.0618 0 11 0C13.9382 0 16.7005 1.14421 18.7782 3.2218C20.8558 5.29947 22 8.0618 22 11C22 13.9382 20.8558 16.7005 18.7782 18.7782C16.7005 20.8558 13.9382 22 11 22Z"
                                                    fill="#E0001A" fill-opacity="0.72"/>
                                                <path
                                                    d="M18.7782 3.2218C16.7005 1.14421 13.9382 0 11 0V22C13.9382 22 16.7005 20.8558 18.7782 18.7782C20.8558 16.7005 22 13.9382 22 11C22 8.0618 20.8558 5.29947 18.7782 3.2218Z"
                                                    fill="#E0001A"/>
                                                <path
                                                    d="M12.9336 15.9414V9.49609H8.20703V10.7852H9.06641V15.9414H8.16406V17.2305H13.75V15.9414H12.9336Z"
                                                    fill="#E4F7FF"/>
                                                <path
                                                    d="M11 8.20703C12.0662 8.20703 12.9336 7.33962 12.9336 6.27344C12.9336 5.20725 12.0662 4.33984 11 4.33984C9.93382 4.33984 9.06641 5.20725 9.06641 6.27344C9.06641 7.33962 9.93382 8.20703 11 8.20703Z"
                                                    fill="#E4F7FF"/>
                                                <path
                                                    d="M11 8.20703C12.0662 8.20703 12.9336 7.33962 12.9336 6.27344C12.9336 5.20725 12.0662 4.33984 11 4.33984V8.20703Z"
                                                    fill="#E0001A" fill-opacity="0.07"/>
                                                <path d="M12.9336 15.9414V9.49609H11V17.2305H13.75V15.9414H12.9336Z"
                                                      fill="#E0001A" fill-opacity="0.07"/>
                                            </svg>
                                        </span>
                                    </label>
                                    <div class="custom-placeholder form-row">
                                        ...
                                        <p class="custom-placeholder__placeholder">Поле должно содержать краткое
                                            описание товара для помощи в поисковой системе.<br><b>Например: комфортная
                                                массивная мебель дивана. Обивка дивана из элитных тканей, основание
                                                сделано из натуральеого дерева, имеются кожаные вставки</b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg mb-3">
                                <div>
                                    <label class="d-flex align-items-end justify-content-between">
                                        ...
                                        <span class="material-tooltip-main d-inline-block" data-toggle="tooltip"
                                              data-tippy-content="Необходимо перечислить, через запятую, ключевые слова, характиризующие товар.<br><b>Например: мягкая мебель, диван, двухместный диван, раскладной диван</b>f">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11 22C8.0618 22 5.29947 20.8558 3.2218 18.7782C1.14421 16.7005 0 13.9382 0 11C0 8.0618 1.14421 5.29947 3.2218 3.2218C5.29947 1.14421 8.0618 0 11 0C13.9382 0 16.7005 1.14421 18.7782 3.2218C20.8558 5.29947 22 8.0618 22 11C22 13.9382 20.8558 16.7005 18.7782 18.7782C16.7005 20.8558 13.9382 22 11 22Z"
                                    ...
                                    <div class="custom-placeholder form-row">
                                        ...
                                        <p class="custom-placeholder__placeholder">Необходимо перечислить, через
                                            запятую, ключевые слова, характиризующие товар.<br><b>Например: мягкая
                                                мебель, диван, двухместный диван, раскладной диван</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        // price type change
        $('#is_price_from').change(function () {
            if ($(this).is(':checked')) {
                $('#price').attr("placeholder", "Цена от");
                $("label[for='price']").text("Цена от");
            } else {
        ...
        // price type change
        $('#is_price_none').change(function () {
            if ($(this).is(':checked')) {
                $('.price_input_wrapper input').attr('readonly', true).val(0);
                /*$('.price_input_wrapper input')*/
            } else {
                $('.price_input_wrapper input').attr('readonly', false);
            }
        })
