        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form action="@isset($data){{ route('admin.type-deliveries.update',$data->id) }}@else{{ route('admin.type-deliveries.store') }}@endisset" class="change-shop pb-4 border-bottom was-validated" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-4 col-lg mb-3">
                                @foreach(config('translatable.locales') as $locale)
                                    <div class="col-4 col-lg mb-3">
                                        @include('layouts.forms.input',['name'=>$locale.'[title]','keyName'=>'title','locale'=>$locale,'label'=>'Название('.strtoupper($locale).')','placeholder'=>'Название('.strtoupper($locale).')','length'=>50,'required'=>true])
                                    </div>
                                @endforeach
                            </div>
                ...
                $(this).closest(".row").find('.imgAdd').before('<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 imgUp">' +
                    '<div class="imagePreview" style="background-image: url(/img/noimg.jpg)"></div>' +
                        ...
                        '<label class="button btn-primary image-load">' +
                            'Загрузить' +
                            '<input type="file" class="uploadFile img" value="Upload Photo" style="width:0px;height:0px;overflow:hidden;" accept=".png, .jpg, .jpeg, .webp">' +
                        '</label>' +
