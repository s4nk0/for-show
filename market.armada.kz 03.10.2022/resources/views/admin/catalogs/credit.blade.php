...
<!--                                <div class="col-12 col-lg-4"></div>-->
                                <div class="col-12 col-lg-3 mb-3 pr-lg-5">
                                ...
                                @foreach(config('translatable.locales') as $locale)
                                    <div class="col-12 col-lg-4 mb-3 pr-lg-5">
                                        @include('layouts.forms.input',['name'=>$locale.'[menu_title]','keyName'=>'menu_title','locale'=>$locale,'label'=>'Название в меню('.strtoupper($locale).')','placeholder'=>'введите данные('.strtoupper($locale).')','length'=>150,'required'=>true])
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="row">
                            @foreach(config('translatable.locales') as $locale)
                                <div class="col-12 col-md-3 mb-3">
                                    @include('layouts.forms.input',['name'=>$locale.'[title]','keyName'=>'title','locale'=>$locale,'id'=>$locale == 'ru'?'title':'','label'=>'Название('.strtoupper($locale).')','placeholder'=>'Название('.strtoupper($locale).')','length'=>150,'required'=>true])
                                </div>
                            @endforeach
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 mb-3">
                                @include('layouts.forms.textarea',['name'=>'svg','label'=>'SVG код иконки','placeholder'=>'SVG код иконки','rows'=>5,'length'=>7000])
                            </div>
                            <div class="col-6 col-lg-6 mb-3">
                                <div class="row">
                                    @foreach(config('translatable.locales') as $locale)
                                        <div class="col-6 mb-3">
                                            @include('layouts.forms.input',['name'=>$locale.'[h1]','keyName'=>'h1','locale'=>$locale,'label'=>'Заголовок H1('.strtoupper($locale).')','placeholder'=>'Заголовок H1('.strtoupper($locale).')','length'=>150,'required'=>true])
                                        </div>
                                    @endforeach
