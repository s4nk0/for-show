        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    ...
                    <form action="@isset($data){{ route('admin.publications.update',$data->id) }}@else{{ route('admin.publications.store') }}@endisset" class="change-shop pb-4 border-bottom was-validated" method="POST"  enctype="multipart/form-data">
