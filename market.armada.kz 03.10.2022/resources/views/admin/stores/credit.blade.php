...
{{--                             /SEO заголовок (Реализовать)--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 mb-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col mb-3">
                                        @include('layouts.forms.input',['name'=>'email','type'=>'email','label'=>'Эл. адрес','placeholder'=>'Эл. адрес','length'=>150])
                                    </div>
                                    <div class="col mb-3">
                            ...
                            <div class="shops__address my-4 duplicate">
                                ...
                                @if(isset($data) and is_array($data->block) and is_array($data->intersection) and is_array($data->butik))
                                    @for($i = 0; $i < max(count($data->block),count($data->intersection),count($data->butik)); $i++)
                                        <div class="duplicate__item d-flex align-items-center" data-duplicate-item-id="{{$i+1}}">
                                            <ul class="row pl-0 list-style-none w-100">
                                                <li class="col-12 col-lg mb-3">
                                                    @include('layouts.forms.input',['name'=>'block','value'=>$data->block[$i] ?? '','array'=>true,'label'=>'Номер блока','placeholder'=>'Номер блока','maxlength'=>50])</li>
                                                <li class="col-12 col-lg mb-3">
                                                    @include('layouts.forms.input',['name'=>'intersection','value'=>$data->intersection[$i] ?? '','array'=>true,'label'=>'Код перекрестка','placeholder'=>'Код перекрестка','maxlength'=>50])</li>
                                                <li class="col-12 col-lg mb-3">
                                                    @include('layouts.forms.input',['name'=>'butik','value'=>$data->butik[$i] ?? '','array'=>true,'label'=>'Номер бутика','placeholder'=>'Номер бутика','maxlength'=>50])</li>
                                            </ul>
