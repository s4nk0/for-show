                            ...
                            @foreach(config('translatable.locales') as $locale)
                                <div class="row">
                                    <div class="col-12 col-lg mb-3">
                                        @include('layouts.forms.textarea',['name'=>$locale.'[body]','key'=>'body','locale'=>$locale,'class'=>'tinyMCE','label'=>'Содержимое('.strtoupper($locale).')','placeholder'=>'Содержимое','cols'=>30,'rows'=>15,'length'=>2000])
                                    </div>
                                </div>
                            @endforeach
                        <div class="row">
