                    ...
                    <form action="@isset($data){{ route('admin.items.update',$data->id) }}@else{{ route('admin.items.store') }}@endisset" class="change-shop pb-4 border-bottom was-validated" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            @foreach(config('translatable.locales') as $locale)
                                <div class="col-12 col-lg-2 mb-3 pr-lg-5">
                        ...
                        <div class="row">
                            @foreach(config('translatable.locales') as $locale)
                                <div class="col-12 col-lg-2 mb-3">
                                    @include('layouts.forms.input',['name'=>$locale.'[title]','keyName'=>'title','locale'=>$locale,'label'=>'Название('.strtoupper($locale).')','placeholder'=>'Название('.strtoupper($locale).')','length'=>150,'required'=>true])
                                </div>
                            @endforeach
