<a href="{{ route('admin.designer-styles.index') }}" class="vendor-menu__row @if(Route::is('*.designer-styles.*')) vendor-menu__row--active @endif">
    ...
    <span class="vendor-menu__row-title">Дизайнерские стили</span>
</a>
