<a href="{{ route('admin.type-pays.index') }}" class="vendor-menu__row @if(Route::is('*.type-pays.*')) vendor-menu__row--active @endif">
    ...
    <span class="vendor-menu__row-title">Способ оплаты</span>
</a>
