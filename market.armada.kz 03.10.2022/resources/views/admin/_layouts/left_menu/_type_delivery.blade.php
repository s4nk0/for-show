<a href="{{ route('admin.type-deliveries.index') }}" class="vendor-menu__row @if(Route::is('*.type-deliveries.*')) vendor-menu__row--active @endif">
    ...
    <span class="vendor-menu__row-title">Виды доставки</span>
</a>
