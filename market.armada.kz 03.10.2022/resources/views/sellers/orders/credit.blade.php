        ...
        <div class="d-flex">
            ...
            <div class="vendor__content flex-grow-1 vendor__content--products">
                ...
                <div class="shops orders vendor__shops pt-4 pb-3 p-xxl-3 pt-xxl-5 pr-0">
                    <form action="{{ route('seller.orders.update',$data->id) }}" class="was-validated change-shop pb-4 border-bottom" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                                ...
                                <div class="bg-light rounded p-4">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <p>
                                                ...
                                                @include('layouts.forms.input',['name'=>'phone','type'=>'tel','other'=>'readonly'])
                                            </p>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <p>
                                                <b>E-mail покупателя:</b>
                                                @include('layouts.forms.input',['type'=>'email','name'=>'email','other'=>'readonly'])
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <p>
                                                <b>Имя получателя:</b>
                                                @include('layouts.forms.input',['type'=>'text','name'=>'client_name','other'=>'readonly'])
                                            </p>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <p>
                                                <b>Телефон получателя:</b>
                                                @include('layouts.forms.input',['type'=>'tel','name'=>'client_phone','other'=>'readonly'])
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <b>Способ доставки: </b>
                                            <select class="mdb-select md-form mt-0" name="delivery_id" searchable="Поиск..." id="delivery_id" required disabled>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <b>Способ оплаты: </b>
                                            <select class="mdb-select md-form mt-0" name="pay_id" searchable="Поиск..." id="pay_id" required disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <p>
                                                <b>Город:</b>
                                                <select class="mdb-select md-form mt-0" name="city" searchable="Поиск..." id="city_id" required disabled>
                                    ...
                                    <p>
                                        <b>Адрес доставки:</b>
                                        @include('layouts.forms.input',['type'=>'text','name'=>'address','other'=>'readonly'])
                                    </p>
                                    <p>
                                        <b>Комментарий заказчика:</b>
                                        @include('layouts.forms.textarea',['name'=>'comment','placeholder'=>'Комментарий заказчика','cols'=>30,'rows'=>8,'length'=>2000,'other'=>'readonly'])
                                    </p>
                                    <p>
                                        <b>Статус: </b>
                                        @include('layouts.forms.select',['name'=>'status','class'=>'mt-0','selected'=>isset($data->status_id) ? $data->status_id : '1','options'=>$statuses_options])
                                    </p>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                    ...
                                    <ul class="seller__products row list-style-none mb-0 p-0">
                                        <li class="col-12 seller__product order-total__item product-card product-card--vertical">
                                            <article class="product-card__wrap product-card__wrap--no-hover">
                                                ...
                                                {{--                                                    </span>--}}
                                                {{--                                                </span>--}}
                                                <a href="{{ route('product',['id'=>$product->id, 'slug' => $product->slug]) }}" class="product-card__link" target="_blank">
                                                    ...
                                                    <div class="product-card__content product-card__content--wp">
                                                        ...
                                                        <div class="price product-card__price mt-3">
                                                            @if(isset($data->price_2) && $data->price_2 > 0)
                                                                <strike class="price__previous">{{ $data->price }} <span class="price__currency">тг.</span></strike>
                                                                <span class="price__special">{{ $data->price_2 }} <span class="price__currency">тг</span></span>
                                                            @else
