                    ...
                    <form action="@isset($data){{ route('seller.stores.update',$data->id) }}@else{{ route('seller.stores.store') }}@endisset" class="was-validated change-shop pb-4 border-bottom" method="POST" enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <div class="alert alert-info alert-dismissible fade show col-lg-6" role="alert">
                                <div class="p-3">
                                    <strong>Добро пожаловать в кабинет продавца!</strong>
                                    Вам необходимо создать свой магазин, заполните все поля ниже и сохраните.
                                    После создания магазина, Вы можете пройти в раздел «товары» и подгружать ваши товарные позиции.
                                </div>
...
{{--                            </div>--}}
                            ...
                            <div class="col-12 col-lg-6 mb-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-md mb-3">
                                        @include('layouts.forms.input',['name'=>'email','type'=>'email','label'=>'Эл. адрес','placeholder'=>'Эл. адрес','length'=>150,'required'=>true,'value'=>Auth::user()->email])
                                    </div>
                                    <div class="col-12 col-md mb-3">
                        ...
                        <div class="row">
                            @include('sellers.stores._phones',['data'=>Auth::user()])
                        </div>
