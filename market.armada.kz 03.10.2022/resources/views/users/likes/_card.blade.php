...
{{--                    <button class="btn_to_basket btn btn-primary btn_to_basket ARMADA_PRODUCT_CART_{{ $item->id }}_CH" data-chosen = 'false' data-product-information='{{ $item->toJson() }}'>--}}
...
{{--                        <button class="btn_to_basket ARMADA_PRODUCT_CART_{{ $item->id }}_CH" data-chosen = 'false' data-product-information='{{ $item->toJson() }}'>--}}
