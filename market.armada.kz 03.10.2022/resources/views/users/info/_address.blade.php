    ...
    <div class="user-block__wrapper d-flex">
        ...
        <form action="{{ route('user.address') }}" class="user-block__wrap" method="POST">
            ...
            <div class="user-block__header">
                <div class="user-block__title">{{__('messages.profile.address')}}</div>
            ...
            <div class="user-block__content">
                <ul class="user-block__items row">
                    <li class="user-block-info user-block__item col-12 col-md-6">
                        <div class="user-block-info__name">{{__('messages.country')}}</div>
                        <div class="user-block-info__value">
                            <div>
                                <span class="d-block mt-2">
                                    {{ $user->city->country->title_ru ?? 'Казахстан' }}
                                </span>
                            </div>
                            <span>
                                {{ $user->city->country->title_ru ?? 'Казахстан' }}
                    ...
                    <li class="user-block-info user-block__item col-12 col-md-6">
                        <div class="user-block-info__name">{{__('messages.city')}}</div>
                        <div class="user-block-info__value">
                            <div>
                                <select class="form-control m-0" name="city_id" searchable="{{__('messages.search')}}...">
                            ...
                            <span>{{ $user->city->title_ru ?? __('messages.not_chosen') }}</span>
                        </div>
                    </li>
                    <li class="user-block-info user-block__item col-12">
                        <div class="user-block-info__name">{{__('messages.address')}}</div>
                        <div class="user-block-info__value">
                            <input type="text" class="form-control" name="address" value="{{ $user->address ?? old('address') }}">
                            <span>{{ $user->address ?? __('messages.not_given') }}</span>
                        </div>
                    </li>
                </ul>
