<div class="user-block">
    ...
    <div class="user-block__success">{{__('messages.profile.edit.success')}}</div>
    <div class="user-block__error">{!! __('messages.profile.edit.error') !!}</div>
    <div class="user-block__wrapper d-flex">
        ...
        <form action="{{ route('user.personal') }}" class="user-block__wrap cmxform" method="POST">
            ...
            <div class="user-block__header">
                <div class="user-block__title">{{__('messages.profile.personal.title')}}</div>
                ...
                <ul class="user-block__items row">
                    ...
                    <li class="user-block-info user-block__item col-12 col-md-6 col-xl-4">
                        ...
                        <div class="user-block-info__value">
                            ...
                            <span>{{ $user->name ?? __('messages.not_given') }}</span>
                        </div>
                    </li>
                    <li class="user-block-info user-block__item col-12 col-md-6 col-xl-4">
                        <div class="user-block-info__name">{{__('messages.profile.personal.middle_name')}}</div>
                        <div class="user-block-info__value">
                            <input type="text" class="form-control" name="mname" value="{{ $user->mname ?? old('mname') }}">
                            <span>{{ $user->mname ?? __('messages.not_given') }}</span>
                        </div>
                    </li>
                    <li class="user-block-info user-block__item col-12 col-md-6 col-xl-4">
                        <div class="user-block-info__name">{{__('messages.profile.personal.dob')}}</div>
                        <div class="user-block-info__value">
                            ...
                            <span>{{ $user->dob ?? __('messages.not_given') }}</span>
                        </div>
                    </li>
                    <li class="user-block-info user-block__item col-12 col-md-6 col-xl-4">
                        ...
                        <div class="user-block-info__value">
                            ...
                            <span>{{ $info->sex->title_ru ?? __('messages.not_chosen') }}</span>
                        </div>
                    </li>
                    <li class="user-block-info user-block__item col-12 col-md-6 col-xl-4">
                        <div class="user-block-info__name">{{__('messages.profile.personal.language_support')}}</div>
                        <div class="user-block-info__value">
                            <div>
                            ...
                            <span>{!! $user->lang->title_ru ?? __('messages.not_chosen')  !!}</span>
                        </div>
                    </li>
                </ul>
