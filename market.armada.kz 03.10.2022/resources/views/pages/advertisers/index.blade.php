...
@section('breadcrumb')
    @php
        ...
        $breadcrumbs[] = [  'route'=>route('advertisers'),
                            'title'=>__('messages.main.advertisers') ];
    @endphp
    ...
    <section class="site-ad container page-info__site-ad">
        <div class="ad-request mb-5 d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-between bg-light rounded pt-3 pb-4 px-3 py-md-4 px-md-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="text-uppercase m-0 font-weight-bold">{{__('messages.application.title')}}</h5>
                    <p class="m-0">{{__('messages.application.text')}}</p>
                    <p class="m-0">{{__('messages.application.text.tel')}} <a href="tel:77272601805" class="white-space-nowrap">+ 7 (727) 260-18-05</a></p>
                </div>
            </div>
            <div class="mt-4 mt-lg-0">
                <a href="#" data-toggle="modal" data-target="#sendRequestAd" class="button btn-primary">{{__('messages.application.ads')}}</a>
                <a href="#" data-toggle="modal" data-target="#sendRequestRent" class="button btn-primary">{{__('messages.application.rent')}}</a>
            </div>
        </div>
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                   aria-controls="pills-home" aria-selected="true">{{__('messages.ads.complex')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                   aria-controls="pills-profile" aria-selected="false">{{__('messages.ads.site')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab"
                   aria-controls="pills-contact" aria-selected="false">{{__('messages.ads.audio')}}</a>
            </li>
            <li class="nav-item">
<!--                <a class="nav-link" id="pills-files-tab" data-toggle="pill" href="#pills-files" role="tab"
                ...
                <a class="nav-link" href="{{ asset('files/kp-armada.pdf') }}" download="КП Армада">{{__('messages.ads.file')}}</a>
            </li>
        </ul>
                    ...
                    <li class="site-ad-item site-ad__item row">
                        ...
                        <div class="site-ad-item__content col-12 col-md-8">
                            <div class="site-ad-item__header">
                                <h4 class="site-ad-item__title">{{__('messages.ads.complex.auto')}}</h4>
                                {!! __('messages.ads.complex.auto.text') !!}
                            </div>
                            <div class="site-ad-item__footer">
                                {!! __('messages.ads.complex.auto.footer') !!}
                            </div>
                        </div>
                    </li>
                    <li class="site-ad-item site-ad__item row">
                        ...
                        <div class="site-ad-item__content col-12 col-md-8">
                            <div class="site-ad-item__header">
                                <h4 class="site-ad-item__title">{{__('messages.ads.complex.banner')}}</h4>
                                <p>{{__('messages.ads.complex.banner.text')}}</p>
                            </div>
                            <div class="site-ad-item__footer">
                                {!! __('messages.ads.complex.banner.footer') !!}
                            </div>
                        </div>
                    </li>
<!--                    <li class="site-ad-item site-ad__item row">
...
{{--                    </div>--}}
                ...
                <div class="row mb-4">
                    <div class="col-12 col-md-6 col-lg-7 col-xl-8">
                        <img src="{{asset('img/endor-format/endor_format_2.jpg')}}" class="img-responsive" alt="endor_format_2"/>
                    </div>
{{--                    <div class="col-12 col-md-6 col-lg-5 col-xl-4">--}}
{{--                        <div class="d-flex py-3 border-bottom">--}}
{{--                            <div class="color--accent mr-3 font-weight-bold">A1</div>--}}
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                <ul class="site-ad__items">
                    <li class="site-ad-item site-ad__item row">
                        ...
                        <div class="site-ad-item__content col-12 col-md-8">
                            <div class="site-ad-item__header">
                                {!! __('messages.ads.audio.header') !!}
                            </div>
                            <div class="site-ad-item__footer">
                                <p class="m-0">{{__('messages.ads.audio.edit_contact')}} <a href="tel:87273271881">8 (727) 327 - 18 - 81</a> </p>
