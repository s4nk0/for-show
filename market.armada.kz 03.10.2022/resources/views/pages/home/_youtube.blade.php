<section class="section slideshow section--slideshow youtube page-home__youtube" data-slides-to-show="4" data-slides-to-show-xs="1" data-unslick-xs="false">
    <div class="container">
        <div class="section__header">
            <h2 class="section__title section__title--dark">{{__('messages.main.youtube_channel')}}</h2>
        ...
        <div class="section__content youtube__content">
            ...
            <ul class="@if(count($videos) > 4) slideshow__items @endif youtube__items d-flex">
                @foreach($videos as $video)
                    <li class="video youtube__item col-12 col-md-6 col-xl-3">
                        <a rel="nofollow" href="{{ $video->url }}" class="video__preview">
                            <img class="lozad" data-src="{{ 'https://img.youtube.com/vi/'. $video->img .'/0.jpg' }}" alt="Video preview">
                        ...
                        <a rel="nofollow" href="https://www.youtube.com/watch?v=ixVrAT-1CvA" class="video__title">{{ $video->title }}</a>
                        <time class="video__date">{{date('d.m.Y',strtotime($video->upload_time)) }}</time>
                    </li>
                @endforeach
            </ul>
