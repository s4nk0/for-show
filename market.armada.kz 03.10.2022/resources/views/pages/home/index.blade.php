...
@section('title','Купить мебель в Алматы | Мебель на заказ')
@section('meta_description',( $catalog->meta_desc ?? 'Купить мебель на заказ в Алматы  ТК «ARMADA» ✅Большой выбор мебели д ✅ В рассрочку и без переплаты ✅ Доставка по всему Казахстану' ) )
...
@push('scripts')
    <script type="text/javascript" src="{{ asset('js/dest/page-home/home.js') }}"></script>
