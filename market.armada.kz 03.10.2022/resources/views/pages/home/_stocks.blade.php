                ...
                @isset($bannerTops)
                    @foreach($bannerTops as $bannerTop)
                        <li class="stocks-item stocks__item col-12 col-xl-6">
                            <a href="{{ route('banner',['link'=>$bannerTop->link]) }}"
                               @if($bannerTop->id != $banner_top_discount_zone_id || $bannerTop->title != $banner_top_discount_zone_title)
                               target="_blank"
                               @endif
                               class="stocks-item__wrap" style="color: #FFF; justify-content: flex-start">
                                <picture>
