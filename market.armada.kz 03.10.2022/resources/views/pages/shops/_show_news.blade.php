    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('messages.store.news')}}</h5>
                    ...
                    @else
                        <li class="news-card news-card--md news__news-card col-12 col-md-6">
                            <article class="news-card__wrap">
                                <footer class="news-card__content">
                                    <div>
                                        <p class="news-card__short-desc">{{__('messages.store.news.none')}}</p>
                                    </div>
                                </footer>
                            </article>
                        </li>
            ...
            <div class="modal-footer p-3">
                <button type="button" class="button btn-primary" data-dismiss="modal">{{__('messages.close')}}</button>
            </div>
        </div>
    </div>
</div>
