...
@section('content')
    <section class="news page-news__news container">
        <h2 class="page-title">{{__('messages.news.title')}}</h2>
        <div class="row align-items-start">
            <ul class="news__tabs nav nav-tabs order-2 order-lg-1 col-12 col-lg-8" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="all-tab" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="true">{{__('messages.all')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="news-tab" data-toggle="tab" href="#news" role="tab" aria-controls="news" aria-selected="false">{{__('messages.main.news')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="article-tab" data-toggle="tab" href="#article" role="tab" aria-controls="article" aria-selected="false">{{__('messages.news.events')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="video-tab" data-toggle="tab" href="#video" role="tab" aria-controls="video" aria-selected="false">{{__('messages.news.video')}}</a>
                </li>
            </ul>
