...
//        }
        ...
        if($request->has('seller') and $request->seller == 'seller'){
            Seller::create($request->only('email','name','sname'));
            $user->role_id = UserRole::SELLER;
        }
        elseif ($request->has('designer') and $request->designer == 'designer'){
