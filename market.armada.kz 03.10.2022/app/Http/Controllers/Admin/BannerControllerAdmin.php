...
class BannerControllerAdmin extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data->uploadDataImage($request->images_1920x550, 'images_1920x550','webp',Banner::BANNER_FOLDER.'-'.$request->type_id);
        $data->uploadDataImage($request->images_1580x550, 'images_1580x550','webp',Banner::BANNER_FOLDER.'-'.$request->type_id);
        $data->uploadDataImage($request->images_1280x450, 'images_1280x450','webp',Banner::BANNER_FOLDER.'-'.$request->type_id);
        $data->uploadDataImage($request->images_1024x450, 'images_1024x450','webp',Banner::BANNER_FOLDER.'-'.$request->type_id);
        $data->uploadDataImage($request->images_768x495, 'images_768x495','webp',Banner::BANNER_FOLDER.'-'.$request->type_id);
        $data->uploadDataImage($request->images_576x350, 'images_576x350','webp',Banner::BANNER_FOLDER.'-'.$request->type_id);
