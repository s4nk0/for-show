...
class AnalyticService
{
    ...
    public function allSalesCount()
    {
        if(isset($_GET['store']))
        {
            $allSalesCount = Order::where('status_id',[OrderStatus::PROCESSING])
                ->where('store_id',$_GET['store'])
                ->count();
        }
        else
    ...
    public function salesCount()
    {
        if(isset($_GET['store']))
        {
            $salesCount = Order::where('status_id',[OrderStatus::PROCESSING])
                ->where('store_id',$_GET['store'])
                ->count();
        }
        else
    ...
    public function orders($value)
    {
        if(isset($_GET['store']))
        {
            $orders = Order::where('status_id',OrderStatus::PROCESSING)
                ->where('store_id',$_GET['store'])
