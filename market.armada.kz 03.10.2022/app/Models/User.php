...
//    protected $dates = ['deleted_at'];
    ...
    protected $fillable = [
        ...
        'additional_phone','additional_phone_additional','additional_phone_comment','additional_social','additional_social_value','facebook_id'
    ];
...
//            ->withDefault(['title_ru'=>'<span class="font-weight-bold text-danger">не указано !!!</span>']);
    }
...
//    }
    ...
    {
        return $this->hasMany(Order::class)->where('status_id','!=',OrderStatus::DELIVERED);
    }
    ...
    public function cartProducts(){
        return $this->belongsToMany(Product::class,'user_cart','user_id','product_id')->withPivot('count')->withTimestamps();
    }
...
//        $fio = ($sname != null or $name != null) ? $sname . ' ' . $name . ' ' . $mname : '<span class="text-danger font-weight-bold">Нет данных !!!</span>';
        $fio = ($sname != null or $name != null) ? $sname . ' ' . $name . ' ' . $mname : '';
        return $fio;
    }
    ...
    {
        return $this->hasOne(DesignerInfo::class);
    }
