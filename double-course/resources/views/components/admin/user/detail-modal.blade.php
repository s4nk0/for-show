<div>
    <form wire:submit.prevent="saveUser" method="post" action="{{route('admin.users.create')}}" id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
    @csrf
    <!--begin::Card body-->
        <div class="card-body border-top p-9">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                            <input type="text" wire:model="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name">
                            <div class="fv-plugins-message-container invalid-feedback">test</div>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8 fv-row">
                    <select wire:model="roles" multiple aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-bold">
            ...
            <div class="row mb-6">
                ...
                <!--begin::Col-->
                <div class="col-lg-8 fv-row">
                    <select wire:model="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." class="form-select form-select-solid form-select-lg fw-bold">
                        <option value="">Select a Country...</option>
