<x-admin-layout>
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$category->title}}</a>
                            </div>
                            <!--end::Name-->
                            ...
                            @if($category->subcategories()->count())
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="fs-2 fw-bolder counted">{{$category->subcategories()->count()}}</div>
                                    </div>
                                    <!--end::Number-->

                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Content</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                                @endif
    ...
    <livewire:admin.content.audio.subcategory.view.index :category="$category" />
</x-admin-layout>
